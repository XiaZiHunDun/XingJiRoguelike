...
func _create_affix(id: StringName, name: String, desc: String, type: Enums.AffixType, value: float):
	var affix = {
		"id": id,
		"name": name,
		"description": desc,
...
func _create_skill(id: StringName, name: String, desc: String,
...
func _create_equipment(id: StringName, name: String, slot: Enums.EquipmentSlot,
