...
const BULLET_TIME_SCALE: float = 0.2  # 子弹时间倍率（完美时机≥90%触发）
...
# ==================== 属性相关 ====================
const ATB_SOFT_CAP: float = 400.0  # ATB速度软上限调整为400以减缓后期数值膨胀
...
const ENERGY_MAX: int = 8  # 能量上限（从5提高到8，让战斗更丰富）
const ENERGY_RESTORE_PER_TURN: int = 4  # 每ATB满恢复能量（从3提高到4）
...
# 稀有度基础数值倍率（相对于白色(1.0)的倍率，白=1.0，绿=1.2，蓝=1.5，紫=2.0，橙=2.5，红=3.0）
const RARITY_BASE_MULT = {
	Enums.Rarity.WHITE: 1.0,
	Enums.Rarity.GREEN: 1.2,
	Enums.Rarity.BLUE: 1.5,
	Enums.Rarity.PURPLE: 2.0,
	Enums.Rarity.ORANGE: 2.5,
	Enums.Rarity.RED: 3.0
}
